...
public class HttpAccessWebservice {
     ...
     */
    public static String httpGetAccessWebservcie(String args0, String args1, String args2,
            String args3) {
     ...
     * @return String类型 返回结果
     */
    public static String httpPostAccessWebservcie(String args0, String args1, String args2,
            String args3) {
        ...
        try {
            ...
            // 对上传参数进行编码
            // String content = "param1=" + URLEncoder.encode("日本7.7",
            // "UTF-8")+"&param2="+ URLEncoder.encode("中国8.15", "UTF-8");
